...
class ExhibitsControllerTest < ActionController::TestCase
  ...
  test "should create exhibit" do
    assert_difference('Exhibit.count') do
      post :create, exhibit: { climate: @exhibit.climate, name: @exhibit.name, year_opened: @exhibit.year_opened }
    end
  ...
  test "should update exhibit" do
    patch :update, id: @exhibit, exhibit: { climate: @exhibit.climate, name: @exhibit.name, year_opened: @exhibit.year_opened }
    assert_redirected_to exhibit_path(assigns(:exhibit))
  end
